...
public partial class Converter
{
    ...
    public string GenerateEditorRazorClassString(ObjectToMap o)
    {
        ...
        sb.AppendLine("        AllowResizing=\"true\" AllowReordering=\"true\" Height=\"615\">");
        sb.AppendLine("");
        ...
        sb.AppendLine("    <GridPageSettings PageSize=\"20\"></GridPageSettings>");
        sb.AppendLine("");
    ...
    public string GenerateEditorClassString(ObjectToMap o)
    {
        ...
        sb.AppendLine($" public void AddButton()");
        sb.AppendLine("{");
        sb.AppendLine($"        this.DefaultGrid.AddRecordAsync();");
        sb.AppendLine("}");
        
        sb.AppendLine($" public void EditButton()");
        sb.AppendLine("{");
        sb.AppendLine($"        this.DefaultGrid.StartEditAsync();");
        sb.AppendLine("}");
        
        sb.AppendLine($" public void DeleteButton()");
        sb.AppendLine("{");
        sb.AppendLine($"        this.DefaultGrid.DeleteRecordAsync();");
        sb.AppendLine("}");
        
        sb.AppendLine($" public void RefreshButton()");
        sb.AppendLine("{");
        sb.AppendLine("");
        sb.AppendLine("}");
        ...
        sb.AppendLine("    {");
        sb.AppendLine("");
        sb.AppendLine($"        var {o.TableName.ToLower()}Result = await {o.EntityName}Service.Get{o.EntityName}sAsync();");
        sb.AppendLine("");
